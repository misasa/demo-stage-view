...
A web interface for **myStage** receives the status information on the topic **stage/info/myStage** and updates the information without reload.

The web interface publishes stage control command on the topic **stage/ctrl/myStage** with message payload of **{"command":"GOTO","d_x":"35.893","d_y":"139.954"}**.
The stage client receives commands on **stage/ctrl/myStage** and control the stage device.
